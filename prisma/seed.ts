...
async function main() {
  ...
  const slides = [
    {
      ...
      media: JSON.stringify({
        ...
        altText: "Hook Island destination placemaking",
      }),
      numberLabel: "01",
    },
    {
      ...
      media: JSON.stringify({
        type: "image",
        url: "/images/69c6647ed177971d4a7ad8ef_67e0ff2d43cf170bd0545d5c_67e0ef988179-slide (1).avif",
        altText: "Luxury hospitality venue atmosphere",
      }),
      numberLabel: "02",
    },
    {
      ...
      media: JSON.stringify({
        type: "image",
        url: "/images/69c6647135e36d82b06fc1d4_67de0a3d91ba6760900cf419_Birdcage_DonJulio_Lana Wilkinson_5.avif",
        altText: "Consumer brand activation Birdcage Don Julio",
      }),
      numberLabel: "03",
    },
  ];
  ...
  const workItems = [
    {
      ...
      description: "129% sales uplift. 500M+ earned reach. 850+ pieces of coverage. Diageo’s most talked-about Australian launch. From unknown in APAC to the one every venue wanted.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd8b004769387bc1f446d_69cbd1d5750c3ab50cd60a53_don-julio-1942_listing-image_67dcfb62fc75610ea069ba4b.webp",
        altText: "Don Julio 1942 by EXAMPLE Agency",
      }),
      link: "/work/don-julio-1942",
      slot: "slot1",
      regionTags: "AUS",
    ...
    },
    {
      ...
      description: "#1 revenue bar at SOLE DXB. 1.9M organic views. 222 pieces of coverage at the ARIAs. 63M reach. Zero paid media. Cultural platform across AMEA and Australia.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd924bf20ab3e58a2d850_69cbd25fe5742986335fea6a_patron-tequila_listing-image_691f176ca5bc9b55d306fdc0.webp",
        altText: "PATRÓN TEQUILA x SOLE DXB by EXAMPLE Agency",
      }),
      link: "/work/patron-tequila",
      slot: "slot1",
      regionTags: "UAE",
      cursorText: "View Work",
      isFeatured: true,
    },
    {
      ...
      description: "Brand architecture, positioning and launch strategy for two new venue concepts at Dubai Harbour.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd89601e4567fdade7e68_69cbd1a0cffaf80b7858f893_addmind-dubai-harbour_listing-image_691f16c8b57321a380233137.webp",
        altText: "Addmind Dubai Harbour by EXAMPLE Agency",
      }),
      link: "/work/addmind-dubai-harbour",
      slot: "slot2",
      regionTags: "UAE",
      cursorText: "View Work",
      isFeatured: true,
    },
    {
      order: 4,
      title: "QT Hotels",
      description: "Multi-year creative partnership. 68% repeat visitation. 203M reach for Newcastle. Mumbrella nominations. Every brief: what would QT dare that others won’t?",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd942141a5e7d231207e4_69cbd28274cb99d4c0331269_qt_listing-image_67dcf66a7f1809ce986282a7.webp",
        altText: "QT Hotels by EXAMPLE Agency",
      }),
      link: "/work/qt",
      slot: "slot3-n",
      regionTags: "AUS",
    ...
    },
    {
      order: 5,
      title: "JW Marriott",
      description: "31% ADR increase. 47% direct booking rate, the highest in the Marriott APAC portfolio. All earned.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd8f60863a79ee4811c5d_69cbd228e5742986335fbefe_jw-marriott-gold-coast_listing-image_67e3998e923cb68cfccd1e55.webp",
        altText: "JW Marriott by EXAMPLE Agency",
      }),
      link: "/work/jw-marriott-gold-coast",
      slot: "slot4",
      regionTags: "AUS",
      cursorText: "View Work",
      isFeatured: true,
    },
    {
      ...
      description: "97 press pieces. 109.5M OTS. Time Out called it the next White Lotus resort. Repositioned as the frontier to the Great Barrier Reef.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd8eb0863a79ee48118c8_69cbd221dffdcea16b997af4_intercontinental-hayman-great-barrier-reef_listing-image_67e3a4b05e5b2611d61816af.webp",
        altText: "InterContinental Hayman Great Barrier Reef by EXAMPLE Agency",
      }),
      link: "/work/intercontinental-hayman-great-barrier-reef",
      slot: "slot3",
      regionTags: "AUS",
      cursorText: "View Work",
      isFeatured: true,
    },
    {
      order: 7,
      title: "Prom Peru",
      description: "8.6M reach. 1.9M video views. 16.7% engagement rate. Four creators, four travel motivations, four reasons to book Peru.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd93971f3ef81ba74e90a_69cbd27a0cd8b7ab56928963_prom-peru_listing-image_67e214efb3b904ad5eca67d0.webp",
        altText: "Prom Peru by EXAMPLE Agency",
      }),
      link: "/work/prom-peru",
      slot: "slot1",
      regionTags: "",
    ...
    {
      order: 8,
      title: "ACCOR 'TABLE FOR', PACIFIC",
      description: "Founding creative partner to Accor’s in-house F&B group. Brand, positioning and launch programme across multiple properties. A hotel world first.",
      media: JSON.stringify({
        type: "image",
        url: "/images/69cbd8924dbeef8886ba5abb_69cbd19f7a24170e1b03b60d_accor-table-for-pacific_listing-image_69253c909e9853d93e84723f.webp",
        altText: "Accor Table For Pacific by EXAMPLE Agency",
      }),
      link: "/work/accor-table-for-pacific",
      slot: "slot1",
      regionTags: "",
      cursorText: "View Work",
      isFeatured: false,
  ...
  const journalPosts = [
    {
      order: 1,
      title: "Your next recommendation isn't human",
      excerpt: "AI only trusts what you've actually earned",
      media: JSON.stringify({
        type: "image",
        url: "/images/6a6c122276e872baab1d79fc_Screenshot_2026-07-07_at_2.30.47_PM.png",
        altText: "AI recommendation in hospitality and marketing",
      }),
      link: "https://news.weareexample.com/p/your-next-recommendation-isnt-human",
      buttonLabel: "Read",
      category: "",
    },
    {
      order: 2,
      title: "Football owns what luxury can't buy",
      excerpt: "48 national teams just became luxury's most underpriced asset ⚽️",
      media: JSON.stringify({
        type: "image",
        url: "/images/6a3b49742a988817f5b0c7a8_fba04c595b6729a0420ee07877f20e00.jpeg",
        altText: "Football culture meets luxury branding",
      }),
      link: "https://news.weareexample.com/p/football-owns-what-luxury-cant-buy",
      buttonLabel: "Read",
      category: "",
    },
    {
      order: 3,
      title: "Volume just stopped paying",
      excerpt: "Why the brands gaining ground are charging more for less.",
      media: JSON.stringify({
        type: "image",
        url: "/images/6a0d55e999311f4638db22c2_CN00043392.jpeg",
        altText: "Premium brand value strategy and pricing",
      }),
      link: "https://news.weareexample.com/p/volume-just-stopped-paying",
      buttonLabel: "Read",
      category: "",
    },
  ];
